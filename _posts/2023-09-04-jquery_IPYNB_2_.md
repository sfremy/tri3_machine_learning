...
<p>
We can't show the actual syntax here, but this example table's construction is viewable in VSCode.
</p>
...
# Using JQuery on a Markdown Table
<p>
This example's cell shows how to use JQuery on a Markdown table.
</p>
